...
[SimpleCommand("show-state")]
public class ShowStateSubcommand : ISimpleCommandAsync
{
    public ShowStateSubcommand(ILogger<ShowStateSubcommand> logger, IUserInterfaceService userInterfaceService, NestedCommand nestedcommand)
    {
        this.logger = logger;
