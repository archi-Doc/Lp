...
public partial class Zen<TIdentifier>
{
    internal partial class FlakeData
    {
        ...
        /*internal (bool Changed, int MemoryDifference) SetMemoryOwnerInternal(ByteArrayPool.MemoryOwner dataToBeMoved, object? obj)
            => this.SetMemoryOwnerInternal(dataToBeMoved.AsReadOnly(), obj);
