...
internal partial class SecondaryFragment : Fragment
{
    public SecondaryFragment(Flake flake)
        : base(flake)
    {
    }
    ...
    {// lock (Flake.syncObject)
        ...
        var memoryOwner2 = this.Flake.Zen.SecondaryPool.Rent(data.Length).ToMemoryOwner(0, data.Length);
