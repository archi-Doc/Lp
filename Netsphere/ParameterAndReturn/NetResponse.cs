...
{
    public NetResponse(NetResult result, ulong dataId, ByteArrayPool.ReadOnlyMemoryOwner received, int elapsedMics)
    {
        this.Result = result;
        this.DataId = dataId;
    ...
    public readonly ByteArrayPool.ReadOnlyMemoryOwner Received;
