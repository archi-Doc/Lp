...
public partial class NetsphereOptions
{
    ...
    {
        Logger.Default.Information($"Address: {this.Address}, Port: {this.Port}");
        Logger.Default.Information($"Alternative: {this.EnableAlternative}, Test features: {this.EnableTestFeatures}");
    }
}
